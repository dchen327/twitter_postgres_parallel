...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/dchen327/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/dchen327/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/dchen327/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/dchen327/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/dchen327/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/dchen327/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |      8m9.205s             |       1m6.836s            | 
| `pg_normalized_batch`  |      3m26.196s            |       0m18.267s           | 
| `pg_denormalized`      |      0m22.423s            |       0m3.301s            | 
